...
$root = array(array('wkt' => $wkt_with_zero, 'srid' => $srid));
$visualization = PMA_GIS_Visualization::getByData($root, $visualizationSettings)
    ->toImage($format);

$open_layers = PMA_GIS_Visualization::getByData($root, $visualizationSettings)
    ->asOl();
