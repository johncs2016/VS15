...
if (isset($_REQUEST['report']) || isset($_REQUEST['report_export'])) {
    $root = PMA_Tracker::getTrackedData(
    ...
    if (! isset($_REQUEST['date_from'])) {
        $_REQUEST['date_from'] = $root['date_from'];
    }
    if (! isset($_REQUEST['date_to'])) {
        $_REQUEST['date_to'] = $root['date_to'];
    }
...
if (isset($_REQUEST['report_export'])) {
    $entries = PMA_getEntries($root, $filter_ts_from, $filter_ts_to, $filter_users);
}
...
if (isset($_REQUEST['report'])
    ...
    $html .= PMA_deleteTrackingReportRows($root);
}

if (isset($_REQUEST['report']) || isset($_REQUEST['report_export'])) {
    $html .= PMA_getHtmlForTrackingReport(
        $url_query, $root, $url_params, $selection_schema, $selection_data,
