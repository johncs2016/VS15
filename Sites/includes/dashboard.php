...
<html>
	<head>
		...
		?>
		<link rel="shortcut icon" href="<?php echo $protocol . $server; ?>/favicon.ico" />
		<script>
			loadCSS("../css/dashboard.css");
			require("../scripts/graphs.js");
	...
	<body>
		...
		<footer id="buttons">
			<a class="button" href="display_steps.php">Step Counts</a>
			<a class="button" href="display_exercise.php">Fitness Classes</a>
			<a class="button" href="display_cardio.php">Cardio Exercises</a>
			<a class="button" href="display_strength.php">Strength Exercises</a>
			<a class="button" href="display_data.php">Weight/Waist Records</a>
			<a class="button" href="display_medical.php">Blood Pressure Records</a>
			<a class="button" href="report.php" target="_blank">Generate PDF</a>
