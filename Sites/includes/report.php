			...
			<table>
				...
				<tbody>
					<tr class="drow">
						...
						<td class="tdata bactivity amiddle"><?php echo display::exercise_count($waist_start_report_date); ?></td>
					</tr>
					<tr class="drow">
						...
						<td class="tdata bactivity amiddle"><?php echo display::activities_count(2, $waist_start_report_date); ?></td>
					</tr>
					<tr class="drow">
						<td class="tlabel">Total Weight Change</td>
						<td class="tdata bweight aright"><?php echo display::display_change(display::getDifference("weight"), false, $iflag); ?></td>
						<td class="tlabel">Bodystep Sessions In Last Month</td>
						<td class="tdata bactivity amiddle"><?php echo display::activities_count(4, $waist_start_report_date); ?></td>
					</tr>
					<tr class="drow">
						<td class="tlabel">Lowest Weight So Far</td>
						<td class="tdata bweight aright"><?php echo display::display_value(tblweeklydata::getMinMaxValue("weight", false, false, true), 1, $iflag); ?></td>
						<td class="tlabel">Aquafit Sessions In last Month</td>
						<td class="tdata bactivity amiddle"><?php echo display::activities_count(5, $waist_start_report_date); ?></td>
					</tr>
					<tr class="drow">
						<td class="tlabel">Highest Weight So Far</td>
						<td class="tdata bweight aright"><?php echo display::display_value(tblweeklydata::getMinMaxValue("weight", false, false, false), 1, $iflag); ?></td>
					...
					<tr class="drow">
						...
						<td class="tdata bwaist aright"><?php echo display::display_change(display::getDifference("waistsize", false, false), true, $iflag); ?></td>
					</tr>
					<tr class="drow">
					</tr>
				</tbody>
