		...
		<script>
			...
			function displayValues() {
				...
				for(i = 0; i < wtelems.length; i++) {
					...
					wtelems[i].innerHTML = (weights[i] == 0 ? "No Data" : display_value(weights[i], 0, isimp, true, true));
					wselems[i].innerHTML = (waists[i] == 0 ? "No Data" : display_value(waists[i], 3, isimp, true, true));
				}
			}
